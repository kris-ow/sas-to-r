...
Traps: raw subtraction is not `--DY`. On the reference date the raw diff is 0; `--DY` is 1. Dates before the reference stay negative and do not shift. Missing either date must stay missing, not become day 0.
